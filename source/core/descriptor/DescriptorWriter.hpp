...
public:
    ...
    void writeImage( const uint32_t binding, const vk::ImageView imageView, const vk::ImageLayout imageLayout,
                     const vk::Sampler sampler, const vk::DescriptorType descriptorType );
    void writeBuffer( const uint32_t binding, const vk::Buffer buffer, const uint32_t range, const std::size_t offset,
