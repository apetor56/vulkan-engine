...
Device::Device(std::shared_ptr<VulkanInstance> vulkanInstance,
               std::shared_ptr<Window> window) : m_vulkanInstance { vulkanInstance },
...
void Device::createSurface() {
    if(glfwCreateWindowSurface(m_vulkanInstance->get(), m_window->getWindowHandler(), nullptr, &m_surface) != VK_SUCCESS) {
