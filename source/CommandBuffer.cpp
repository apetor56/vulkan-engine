...
CommandBuffer::CommandBuffer( std::shared_ptr< PhysicalDevice > physicalDevice,
                              std::shared_ptr< LogicalDevice > logicalDevice, std::shared_ptr< Swapchain > swapchain,
...
void CommandBuffer::createCommandPool() {
    QueueFamilyIndices queueFamilyIndices{ QueueFamilyIndices::findQueueFamilies( m_physicalDevice->getHandler(),
