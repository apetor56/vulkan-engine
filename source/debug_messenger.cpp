...
VkResult DebugMessenger::getDebugUtilsMessengerEXT(const VkInstance instance,
...
void DebugMessenger::destroyDebugUtilsMessengerEXT(const VkInstance instance,
